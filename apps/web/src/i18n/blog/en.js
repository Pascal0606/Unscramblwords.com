export const en = [
    ...
    },
    {
      ...
      body: [
        "Written and reviewed by the UnscramblWords Team.",
        "Scrabble has a rich and fascinating history that spans nearly a century. The game was invented by Alfred Mosher Butts, an architect from New York who found himself out of work in the 1930s. Determined to create a popular pastime, Butts spent years analysing letter frequencies in newspapers and books to design a balanced, challenging word game.",
    ...
    },
    {
      ...
      body: [
        ...
        "It is important to note that the scientific community has not established a definitive causal link between word game playing and the prevention of cognitive decline. Leading health bodies take the position that while keeping the brain active is beneficial, no single activity has been proven to prevent age-related cognitive decline on its own.",
        ...
        "Sources: Bialystok, Craik & Freedman (2007), Neuropsychologia, on bilingualism and delayed onset of age-related cognitive symptoms; Stern (2002) on the cognitive reserve concept; public guidance on brain health from leading health bodies."
      ]
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        "Information theory offers a useful framework for Wordle strategy. The idea is that the optimal guess at each step is the one that maximises the expected information gained from the response — which is part of why words like CRANE are considered strong openers, since they tend to produce informative feedback across a wide range of possible solutions. A 2026 study by researchers at Binghamton University tested this idea directly: an entropy-based strategy that always picks the guess expected to reveal the most information solved 99% of simulated puzzles, compared with 90% for a simpler common-letter approach.",
