export const en = [
    ...
    },
    {
      ...
      body: [
        ...
        "Research led by Ellen Bialystok and colleagues at York University found that bilingual participants maintained sharper cognitive performance for an average of four to five years longer than monolingual participants with otherwise comparable backgrounds. Playing word games in multiple languages — as UnscramblWords enables — may offer a similar kind of compounded benefit, by exercising language systems in more than one linguistic context.",
        "Working memory — the ability to hold and manipulate information over short periods — gets a real workout during word games. In Scrabble, players hold their tile rack in mind, scan the board for opportunities, calculate scores, and anticipate their opponent's next move, often all in the same turn. This kind of multitasking places real demands on working memory, a skill closely linked to general problem-solving ability.",
        "Attention and concentration are exercised too. Competitive Scrabble calls for sustained focus over stretches of 30 minutes to several hours, and regular practice holding that level of concentration may carry over into other parts of daily life.",
        "It's worth being clear about what this evidence does and doesn't show: no single activity, word games included, has been proven on its own to guarantee any particular long-term outcome. Researchers generally describe mental stimulation as one part of a broader picture — alongside social engagement, physical activity, and diet — rather than a standalone solution.",
        "Word games, particularly when played with others, cover at least two of those bases at once: mental stimulation and social engagement, in a single activity.",
